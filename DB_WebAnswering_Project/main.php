...
<div class="tab">
    <button class="tablinks" onclick="openCity('Home')">Home</button>
    <button class="tablinks" onclick="openCity('My Questions')">My Questions</button>
    <button class="tablinks" onclick="openCity('My Answers')">My Answers</button>
    <button class="tablinks" onclick="openCity('Profile')">Profile</button>
</div>
...
<div id="Home" class="tabcontent" style="display:block">
    ...
    <form method="post" action="search.php">
        ...
        <input type="text" name="id" class="search" placeholder="Search...." required/>
        <input type="submit" name="submit" value="Search" class="sb">
    ...
    while ($row1 = mysqli_fetch_array($my_question)) {
        ...
        $my_answer = 'select * from WebAnsweringSystem.Answer where Answer.Qid=' . $row1['Qid'] . ' order by date desc';
...
<div id="Profile" class="tabcontent">
    ...
    <div class="profilecon">
        ...
        <label><a href="logout.php" tite="Logout" class="logout">Logout</a></label>
        <br>
';
    }
    echo $str;
